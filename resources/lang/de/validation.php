...
return [
    ...
    */
    ...
    'accepted_if'          => ':attribute muss akzeptiert werden wenn :other = :value.',
    ...
    'gt' => [
        'numeric' => ':attribute muss gr&ouml;&szlig;er sein als :value.',
        'file' => ':attribute muss gr&ouml;&szlig;er sein als :value kilobytes.',
        'string' => ':attribute muss gr&ouml;&szlig;er sein als :value characters.',
        'array' => ':attribute muss mehr als :value Objekte enthalten.',
    ],
    'gte' => [
        'numeric' => ':attribute muss gr&ouml;&szlig;er sein als oder gleich :value.',
        'file' => ':attribute muss gr&ouml;&szlig;er sein als oder gleich :value kilobytes.',
        'string' => ':attribute muss gr&ouml;&szlig;er sein als oder gleich :value characters.',
        'array' => ':attribute muss :value oder mehr Objekte enthalten.',
    ],
    ...
    'lt' => [
        ...
        'string' => ':attribute muss kleiner sein als :value characters.',
        'array' => ':attribute muss weniger als :value Objekte enthalten.',
    ],
    'lte' => [
        'numeric' => ':attribute muss kleiner sein als oder gleich :value.',
        'file' => ':attribute muss kleiner sein als oder gleich :value kilobytes.',
        'string' => ':attribute muss kleiner sein als oder gleich :value characters.',
        'array' => ':attribute muss :value oder weniger Objekte enthalten.',
    ],
    'max'                  => [
    ...
    'multiple_of'          => ':attribute muss ein mehrfaches von :value sein.',
    'not_in'               => 'Ausgew&auml;hlte(s) :attribute ist inkorrekt.',
    'not_regex'            => 'Das Format von :attribute nicht valide.',
    ...
    'prohibited_if'        => 'Das Feld :attribute ist verboten wenn :other = :value.',
    'prohibited_unless'    => 'Das Feld :attribute ist verboten, außer :other ist Teil von :values.',
    'prohibits'            => 'Das Feld :attribute verbietet die Präsenz von :other.',
    ...
    'starts_with' => ':attribute muss mit einem der folgenden Werte anfangen: :values.',
